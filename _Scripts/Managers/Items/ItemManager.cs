...
public class ItemManager : MonoBehaviour {
	...
	void Awake() {
        ...
        // Health Potion
        items[0] = new Item("Health Potion", eItemType.healing, eItemStatEffect.HP, 30, 45, 8,
        "Replenishes at least 30 HP." + "\n Value: 8 Gold", itemSprite[0]);

        // Magic Potion
        items[1] = new Item("Magic Potion", eItemType.healing, eItemStatEffect.MP, 12, 20, 24,
        "Replenishes at least 12 MP." + "\n Value: 24 Gold", itemSprite[1]);

        // Ass Sword
        items[2] = new Item("Ass Sword", eItemType.weapon, eItemStatEffect.STR, 10, 10, 5,
        ...
        // Ass Armor
        items[5] = new Item("Ass Armor", eItemType.armor, eItemStatEffect.DEF, 6, 6, 7,
        "Adds to Defense like some ASS ARMOR! +6!" + "\n Value: 7 Gold", itemSprite[5]);

        // Ass Helmet
        items[6] = new Item("Ass Helmet", eItemType.helmet, eItemStatEffect.DEF, 9, 9, 9,
        "Adds to Defense like an ASS HELMET! +9!" + "\n Value: 9 Gold", itemSprite[6]);

        // Ass Other
        items[7] = new Item("Ass Other", eItemType.other, eItemStatEffect.AGI, 9, 9, 9,
        "Adds to Agility like an ASS OTHER! +9!" + "\n Value: 9 Gold", itemSprite[7]);

        // Crap Sword
        items[8] = new Item("Crap Sword", eItemType.weapon, eItemStatEffect.STR, 12, 12, 6,
        ...
        // Small Key
        items[11] = new Item("Small Key", eItemType.other, eItemStatEffect.nothing, 0, 0, 0,
        "A small key that fits into any small lock found on any small door. BIZARRE, BIZZARE!" + "\n Value: 0 Gold", itemSprite[11]);

        // Bug_1
        items[12] = new Item("Nut Bat", eItemType.ingredient, eItemStatEffect.nothing, 0, 0, 15,
        "A nutty little bat filled with blood of Michael Geen's birthday delight. Cheers, butthead!" + "\n Value: 15 Gold", itemSprite[12]);

        // Bug_2
        items[13] = new Item("Violet Pilot", eItemType.ingredient, eItemStatEffect.nothing, 0, 0, 15,
        ...
        // Bug_4
        items[15] = new Item("Orange Ollie", eItemType.ingredient, eItemStatEffect.nothing, 0, 0, 15,
        "Flap, flap, flap! What's this guy up to?" + "\n Value: 15 Gold", itemSprite[15]);

        // Bug_5
        items[16] = new Item("Blue Betty", eItemType.ingredient, eItemStatEffect.nothing, 0, 0, 15,
        ...
        // Blah Weapon
        items[18] = new Item("Blah Weapon", eItemType.weapon, eItemStatEffect.STR, 1, 1, 5,
        "Bad weapon." + "\n Value: 5 Gold", itemSprite[18], true);

        // Blah Armor
        items[19] = new Item("Blah Armor", eItemType.armor, eItemStatEffect.DEF, 1, 1, 5,
        "Crummy armor." + "\n Value: 5 Gold", itemSprite[19], true);

        // Blah Helmet
        items[20] = new Item("Blah Helmet", eItemType.helmet, eItemStatEffect.DEF, 1, 1, 5,
        "Terrible helmet." + "\n Value: 5 Gold", itemSprite[20], true);

        // Blah Other
        items[21] = new Item("Blah Other", eItemType.other, eItemStatEffect.AGI, 1, 1, 5,
        "Stupid other." + "\n Value: 5 Gold", itemSprite[21], true);

        // Heal All Potion
        items[22] = new Item("Heal All Potion", eItemType.healing, eItemStatEffect.HP, 12, 20, 20,
        ...
        // Revive Potion
        items[24] = new Item("Revive Potion", eItemType.healing, eItemStatEffect.HP, 12, 20, 25,
