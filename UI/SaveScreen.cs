...
public class SaveScreen : MonoBehaviour {
	...
	void LoadFile(int fileNdx) {
		...
		Party.S.stats.Add(new PartyStats("Blob", 40, 40, 40, 6, 6, 6,
			2, 2, 2, 2, 1, 1, 1, 1,
			0, 1, 6,
			new List<Spell> { SpellScreen.S.spellManager.spells[1], SpellScreen.S.spellManager.spells[0], SpellScreen.S.spellManager.spells[2], SpellScreen.S.spellManager.spells[4], SpellScreen.S.spellManager.spells[5], SpellScreen.S.spellManager.spells[3] },
		...
		Party.S.stats.Add(new PartyStats("Bill", 32, 32, 32, 15, 15, 15,
			1, 1, 1, 1, 2, 2, 2, 2,
			0, 1, 2,
			new List<Spell> { SpellScreen.S.spellManager.spells[0], SpellScreen.S.spellManager.spells[1], SpellScreen.S.spellManager.spells[3], SpellScreen.S.spellManager.spells[4], SpellScreen.S.spellManager.spells[5], SpellScreen.S.spellManager.spells[2] },
			new List<bool>(new bool[30]),
		...
		Party.S.stats.Add(new PartyStats("Fake Bill", 25, 25, 25, 10, 10, 10,
			1, 1, 1, 1, 2, 2, 2, 2,
			0, 1, 6,
			new List<Spell> { SpellScreen.S.spellManager.spells[4], SpellScreen.S.spellManager.spells[3], SpellScreen.S.spellManager.spells[0], SpellScreen.S.spellManager.spells[2], SpellScreen.S.spellManager.spells[1], SpellScreen.S.spellManager.spells[5] },
			new List<bool>(new bool[30]),
			new List<int> { 0, 0, 9, 23, 55, 110, 250, 450, 850, 1300, 2100 },
			false, 0)
		);
